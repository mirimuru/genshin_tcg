...
状態コピー・シミュレーション、確率結果、ダイスChance Node、カードTarget、装備、元素反応、イベント、合法手生成、状態評価、CPU探索、CPUのChance Node評価、Transposition Tableなどを含むテストを実施しています。

## 今後の予定

1. 探索性能を改善し、深い探索を安定して実行できるようにする
2. 武器・聖遺物・Target付きカードを増やす
